...
if __name__ == '__main__':
	...
	paths_extends = {
		...
		'HYBRID': ['../../monte_carlo/', '_Enhancedextra'],
		'HRUSHCKA_MNL_HYP': ['../../monte_carlo_Hruschka/', '_Hruschka07'],
		'HRUSHCKA_FULL_MNL_HYP': ['../../monte_carlo_Hruschka/', '_Hruschka07_Full'],
		'HRUSHCKA_FULL_MNL_HYP_100': ['../../monte_carlo_Hruschka/', '_Hruschka07_Full_100'],
	...
	pickle.dump(encyclopedia, open('Encyclopedia_monte_carlo_Hrusch.p', 'wb'))
