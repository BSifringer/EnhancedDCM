...
parser.add_argument('--experiment', action='store_true', help='Runs MNL and multiple increasing size L-MNL on illustrative utility function')
...
if __name__ == '__main__':
	...
	if experiment:
		...
		beta_num = 2
		nExtraFeatures = 5
		# _,_, train_data_name = generatedDM.keras_input(filePath+folderName,fileInputName, filePart = extensions[0], correlArchitecture = correlArchitecture) # create keras input for train set
		# _, saveExtension = GeneratedMixed(filePath+folderName, fileInputName, beta_num, choices_num, nExtraFeatures,
